...
app.controller('mainCtrl',['$scope', 'itunesService', function($scope, itunesService){
  ...
  $scope.getSongData = function() {
      ...
      itunesService.getItunesData($scope.artist).then(function(response) {
  ...
  //Check that the above method is working by entering a name into the input field on your 
  //web app, and then console.log the result
  ...
  */
  ...
  //array objects that look like the above data.
